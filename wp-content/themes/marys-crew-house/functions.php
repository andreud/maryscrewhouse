<?php
/**
 * Marys Crew House functions and definitions
 *
...
if ( ! function_exists( 'marys_crew_house_setup' ) ) :
	/**
	 ...
	 */
	function marys_crew_house_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on Marys Crew House, use a find and replace
		 * to change 'marys-crew-house' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'marys-crew-house', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'marys-crew-house' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'marys_crew_house_custom_background_args', array(
...
add_action( 'after_setup_theme', 'marys_crew_house_setup' );
 ...
 */
function marys_crew_house_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'marys_crew_house_content_width', 640 );
}
add_action( 'after_setup_theme', 'marys_crew_house_content_width', 0 );
 ...
 */
function marys_crew_house_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'marys-crew-house' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'marys-crew-house' ),
...
add_action( 'widgets_init', 'marys_crew_house_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function marys_crew_house_scripts() {
